...
function Product() {
    const coHandler = async ({ name, amount }) => {
        ...
        console.log({ order })
        var options = {
            "key": "rzp_live_uZqf3G3ZLTSKbH", // Enter the Key ID generated from the Dashboard
            "amount": order.amount, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
            "currency": order.currency,
            "name": "Abhiii Super Mall",
            "description": "Test Transaction",
            "image": "https://c8.alamy.com/comp/2HCCHB0/ak-letter-linked-business-logo-ak-logo-design-ak-logo-design-for-financial-development-investment-real-estate-and-management-company-vector-2HCCHB0.jpg",
            "order_id": order.id, //This is a sample Order ID. Pass the `id` obtained in the response of Step 1
            "callback_url": "/api/payment/payment-verification",
            "prefill": {
                "name": "Abhijeet Kokat",
                "email": "abhijeetkokat2003@gmail.com",
                "contact": "9373700515"
            },
            "notes": {
            ...
            <div className='flex flex-wrap justify-center'>

                {
                    allproduct.map((product, i) => {
                        const { _id, image, title, description, price, thumbnail, category, CheckoutHandler } = product;
                        return (
                                ...
                                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="flex items-center flex-wrap">
                                            <button class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" onClick={() => coHandler({ name: title, amount: price })}>Bye Now
